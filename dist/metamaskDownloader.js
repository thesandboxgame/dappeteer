...
exports.default = (version, location, idx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { filename, downloadUrl, tag } = yield getMetamaskReleases(version, idx);
...
const getMetamaskReleases = (version, idx) => new Promise((resolve, reject) => {
    // eslint-disable-next-line @typescript-eslint/naming-convention
