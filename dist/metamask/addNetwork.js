...
exports.addNetwork = (page, version) => ({ networkName, rpc, chainId, symbol, explorer, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield page.waitForSelector('button.button.btn-danger');
    const logo = yield page.waitForSelector('.app-header__logo-container.app-header__logo-container--clickable');
    yield logo.click();
